...
class HadithUseCase {
  ...
  Future<void> fetchAddHadith(
      {required Map<String, dynamic> mapHadith}) async {
    try {
      return await _hadithRepository.addHadith(
          mapHadith: mapHadith);
    } catch (e) {
      throw Exception(
          'Ошибка при добавлении хадиса:\n\n$e');
    }
  }
    Future<void> fetchChangeHadith(
      {required int hadithId,required Map<String, dynamic> mapHadith}) async {
    try {
      return await _hadithRepository.changeHadith(hadithId: hadithId,
          mapHadith: mapHadith);
    } catch (e) {
      throw Exception(
          'Ошибка при изменении хадиса:\n\n$e');
    }
  }
    Future<void> fetchRemoveHadith(
      {required int hadithId}) async {
    try {
      return await _hadithRepository.removedHadith(hadithId: hadithId);
    } catch (e) {
      throw Exception(
          'Ошибка при удалении хадиса:\n\n$e');
    }
  }
}
